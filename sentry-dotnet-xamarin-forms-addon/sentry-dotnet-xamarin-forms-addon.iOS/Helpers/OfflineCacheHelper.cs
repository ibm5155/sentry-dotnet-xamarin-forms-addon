...
namespace SentryNetXamarinAddon.iOS.Helpers
{
    public class OfflineCacheHelper : IOfflineCacheHelper
    {
        private readonly string _logFileFolder = Environment.GetFolderPath(System.Environment.SpecialFolder.Personal) + "/" + "CacheLog";
